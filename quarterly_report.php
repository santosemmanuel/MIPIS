			...
			<div class="col-md-12">
				...
				<div class="col-md-10">
					...
					<div class="page-header">
						<h1>Quarterly Report &nbsp;<small></small></h1>
					</div>
					<!-- / -->
								...
								<form class="form-inline" method="post">
                                    ...
                                    <div class="panel-heading">
		  							...
		  							<div class="panel-footer">
                                        <a href="print_report_quarterly.php?quarterly_rep_type=<?php echo $quarterly_report_type;?>&&year_1=<?php echo $year_1;?>&&year_2=<?php echo $year_2;?>&&user_position=student&&month_count_1=<?php echo $month_count_1;?>&&month_count=<?php echo $_POST['month_count'];?>&&semester=<?php echo $semester;?>">
