			...
			<div class="col-md-12">
				...
				<div class="col-md-10">
					...
					<ol class="breadcrumb">
                        ...
                        <li><a href="report_monthly.php">Monthly Report</a></li>
						<li class="active">Student Monthly Report</li>
						<li style="float: right"><?php  echo date('l jS \of F Y');?></li>
					</ol>
					
					<div class="page-header">
						<h1>Student Monthly Report &nbsp;<small></small></h1>
					</div>
					<!-- / -->
								...
								<div class="panel panel-default">
		  							...
		  							<div class="panel-footer">
		  									<div style="margin-left: 85%">
                                                <a href="print_report_monthly.php?year=<?php echo $year;?>&&month=<?php echo $month;?>&&month_rep_type=<?php echo $month_report_type;?>&&var_month_rep=<?php echo $var_month_report;?>&&user_position=student">
