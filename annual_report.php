			...
			<div class="col-md-12">
				...
				<div class="col-md-10">
					...
					<ol class="breadcrumb">
                        ...
                        <li><a href="report_annual.php">Annual Report</a></li>
                        <li class="active">Student Annual Report</li>
						<li style="float: right"><?php  echo date('l jS \of F Y');?></li>
					</ol>
					
					<div class="page-header">
						<h1>Student Annual Report &nbsp;<small></small></h1>
					</div>
					<!-- / -->
										...
										?>
											<table class="table table-bordered table-condensed table-reponsive">
												<thead>
													...
													<?php
														...
														$an_year = $year_2 - 1;
														if($an_year == $year_1){
															$arr_year_1 = array("June" => "$year_1/6", "July" => "$year_1/7","August"=>"$year_1/8", "September" => "$year_1/09", "October" => "$year_1/10");
											...
											<div class="panel-footer">
												<div style="margin-left: 85%">
													<a href="print_report_annual.php?annual_rep_type=<?php echo $annual_report_type;?>&&year_1=<?php echo $year_1;?>&&year_2=<?php echo $year_2;?>&&user_position=student">
